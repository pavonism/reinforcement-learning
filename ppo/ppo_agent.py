...
class PPO:
    def __init__(self, actor_critic, input_dim, action_dim, buffer, device, learning_rate=2.5e-4, gamma=0.99, clip_epsilon=0.1,
                 value_coeff=0.75, entropy_coeff=0.05, num_epochs=15):
